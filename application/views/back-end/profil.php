                    ...
                    <div class="card profile-card">
                        ...
                        <div class="profile-body">
                            <div class="image-area">
                                <img src="<?=base_url('asset/template/')?>images/user-lg.jpg" alt="AdminBSB - Profile Image" />
                            </div>
                            <div class="content-area">
                                <h3>Marc K. Hammond</h3>
                                <p>Kantor Desa Melayu</p>
                                <p>Administrator</p>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="tab-content">
                                            ...
                                            <div class="panel-heading">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                            <img src="<?=base_url('asset/template/')?>images/user-lg.jpg" />
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="post">
                                                    ...
                                                    <div class="post-content">
                                                        <img src="<?=base_url('asset/template/')?>images/profile-post-image.jpg" class="img-responsive" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="change_password_settings">
                                        <form class="form-horizontal">
                                            <div class="form-group">
                                                <label for="OldPassword" class="col-sm-3 control-label">Kata Sandi Baru</label>
                                                <div class="col-sm-9">
                                                    <div class="form-line">
                                            ...
                                            <div class="form-group">
                                                <label for="NewPassword" class="col-sm-3 control-label">Komfirmasi Kata Sandi</label>
                                                <div class="col-sm-9">
                                                    <div class="form-line">
